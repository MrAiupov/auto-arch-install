...
# Install Minimum Arch Linux - Быстрая установка Arch Linux на освнове https://github.com/ordanax/arch2018
# Цель скрипта - быстрое развертывание системы с вашими персональными настройками (DE, темы, программы и т.д.).
...
arch-chroot /mnt sh -c "$(curl -fsSL git.io/Jfs4L)"
