...
2) Скачать и запустить скрипт командой. Обратите внимание, что тут сокращенная ссылка 
через git.io, которая ведёт на первый скрипт файл в режима Raw просмотра, а в конце данного 
скрипта идёт автоисполнение второго скрипта, где так же сокращеная ссылка через git.io,
